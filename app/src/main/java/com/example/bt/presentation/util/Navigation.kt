...
import com.example.bt.presentation.add_edit_transaction.AddEditTransaction
import com.example.bt.presentation.dashboard.Dashboard
import com.example.bt.presentation.transaction_details.TransactionDetails
import com.example.bt.presentation.transactions.Transactions
                ...
                Box(
                    ...
                    Column {
                        FloatingActionButton(onClick = {
                            navController.navigate(Screen.AddEditTransaction.route + "/-1" + "/dashboard")
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.bt.R.string.dashboard),
                )
            },
            label = {
                Text(text = "Dashboard")
            ...
            selectedContentColor = Color(0xFF77B0AA),
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.bt.R.string.transactions),
                )
            },
            label = {
